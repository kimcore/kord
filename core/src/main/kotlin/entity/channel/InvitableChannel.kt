...
interface InvitableChannel : GuildChannel
/**
...
suspend inline fun InvitableChannel.createInvite(builder: InviteCreateBuilder.() -> Unit = {}): Invite {
